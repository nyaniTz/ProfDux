...
function startTranslation() {
    ...
    function get_lang_href(lang) {
        ...
        if (url_structure == "sub_directory") {
            var gt_request_uri =
                (document.currentScript.getAttribute("data-gt-orig-url") || (location.pathname.startsWith("/" + current_lang + "/") && "/" + location.pathname.split("/").slice(2).join("/")) || location.pathname) +
                location.search +
                location.hash;
            ...
            if (typeof custom_domains == "object" && custom_domains[lang]) href = (lang == default_language && location.protocol + "//" + domain + gt_request_uri) || location.protocol + "//" + custom_domains[lang] + gt_request_uri;
    ...
    if (float_switcher_open_direction == "left" || float_switcher_open_direction == "right") {
        ...
        max_width += "px";
        if (switcher_horizontal_position == "inline") max_width = "calc(100% - 122px)";
        widget_css +=
        ...
        widget_css +=
            ...
            (switcher_horizontal_position != "inline" && "text-align:" + switcher_horizontal_position) +
            "}";
    } else {
    ...
    if (switcher_horizontal_position == "inline") widget_code += '<div id="gt_float_wrapper"><div class="gt_float_switcher notranslate" style="opacity:0">';
    else widget_code += '<div id="gt_float_wrapper" style="position:fixed;' + switcher_vertical_position + ":20px;" + switcher_horizontal_position + ':20px;z-index:999999;"><div class="gt_float_switcher notranslate" style="opacity:0">';
    var gt_current_div =
    ...
    gt_options_div += "</div>";
    if ((switcher_vertical_position == "top" && float_switcher_open_direction == "bottom") || (switcher_vertical_position == "bottom" && float_switcher_open_direction == "bottom")) widget_code += gt_current_div + gt_options_div;
    ...
    function gt_hscroll(evt) {
        ...
        if (evt.type == "mousewheel") {
            ...
            tgt.scrollTo({ left: tgt.scrollLeft + scroll_speed * 500, behavior: "smooth" });
        }
    }
    function gt_show_float_switcher(el) {
        gt_float_open = true;
        if (switcher_horizontal_position == "inline") el.querySelector(u_class + " .gt_options").style.maxWidth = el.parentNode.clientWidth - el.clientWidth - 1 + "px";
