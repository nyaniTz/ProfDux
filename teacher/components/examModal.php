    ...
    <div class="exam-modal-container">
      ...
      <div class="exam-modal-container-second-div">
        ...
        <div class="exam-modal-minutes">
          ...
          <input type="number" style="border:1px solid #6f2036;padding:15px;border-radius:10px;margin-top:15px" required value="0" />
        </div>
        <div class="exam-modal-date">
          <h3 class="exam-modal-hardness-title" style="margin-top:20px">Select Exam Time</h3>
          <input type="date" style="border:1px solid #6f2036;padding:15px;border-radius:10px;margin-top:15px" required />
        </div>
